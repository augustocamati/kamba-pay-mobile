...
const styles = StyleSheet.create({
  ...
  deadlineText: { fontSize: 12, color: Colors.child.textSecondary, fontFamily: 'Nunito_600SemiBold' },
  title: { fontSize: 24, fontFamily: 'Nunito_800ExtraBold', color: Colors.child.text, marginBottom: 8 },
  description: { fontSize: 16, color: Colors.child.textSecondary, fontFamily: 'Nunito_400Regular', lineHeight: 22, marginBottom: 20 },
  rewardBox: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: 'rgba(255,140,0,0.05)', padding: 16, borderRadius: 16 },
  rewardLabel: { fontSize: 12, color: Colors.child.textSecondary, fontFamily: 'Nunito_600SemiBold', textTransform: 'uppercase' },
  rewardValue: { fontSize: 20, fontFamily: 'Nunito_800ExtraBold', color: '#FF8C00' },
  sectionTitle: { fontSize: 16, fontFamily: 'Nunito_700Bold', color: Colors.child.text, marginBottom: 12, marginLeft: 4 },
  ...
  noImageText: { color: Colors.child.textSecondary, marginTop: 12, fontSize: 14, fontFamily: 'Nunito_600SemiBold' },
  ...
  submitBtnText: { color: '#fff', fontSize: 18, fontFamily: 'Nunito_700Bold' },
  ...
  rejectionTitle: { color: '#EF4444', fontFamily: 'Nunito_700Bold', fontSize: 15 },
  rejectionText: { color: '#B91C1C', fontSize: 14, fontFamily: 'Nunito_400Regular', fontStyle: 'italic' }
});
