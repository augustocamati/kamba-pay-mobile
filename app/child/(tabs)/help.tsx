...
const styles = StyleSheet.create({
  ...
  balanceLabel: { color: '#fff', fontSize: 14, fontFamily: 'Fredoka_700Bold' },
  balanceValue: { color: '#fff', fontSize: 36, fontFamily: 'Fredoka_700Bold', marginTop: 4 },
  card: {
  ...
  cardBody: { padding: 20 },
  cardTitle: { fontSize: 20, fontFamily: 'Fredoka_700Bold', color: '#1E293B' },
  ...
  progressLabel: { fontSize: 13, fontFamily: 'Fredoka_700Bold', color: '#1E293B' },
  progressValue: { fontSize: 13, fontFamily: 'Fredoka_700Bold', color: '#1E293B' },
  ...
  metaText: { fontSize: 12, fontFamily: 'Fredoka_700Bold', color: '#45D37B' },
  donateButton: {
    backgroundColor: '#2965FF', flexDirection: 'row', alignItems: 'center',
    justifyContent: 'center', paddingVertical: 14, borderRadius: 16, gap: 8,
  },
  donateButtonText: { color: '#fff', fontSize: 15, fontFamily: 'Fredoka_700Bold' },
  ...
  modalTitle: { fontSize: 18, fontFamily: 'Fredoka_700Bold', color: '#1E293B' },
  modalCampanha: { fontSize: 14, fontFamily: 'Fredoka_700Bold', color: '#334155' },
  ...
  suggestedText: { fontSize: 12, fontFamily: 'Fredoka_700Bold', color: '#334155' },
