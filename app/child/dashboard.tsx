...
const pillarStyles = StyleSheet.create({
  ...
  value: { fontSize: 16, fontFamily: 'Nunito_800ExtraBold' },
  label: { fontSize: 11, fontFamily: 'Nunito_600SemiBold', color: Colors.child.textSecondary },
});
...
const styles = StyleSheet.create({
  ...
  heroGreeting: { fontSize: 24, fontFamily: 'Nunito_700Bold', color: '#0B1A2E' },
  levelBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 4,
    backgroundColor: 'rgba(255,255,255,0.6)', borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4, marginTop: 6,
    alignSelf: 'flex-start',
  },
  levelText: { fontSize: 12, fontFamily: 'Nunito_700Bold', color: '#0B1A2E' },
  logoutBtn: {
  ...
  balanceLabel: { fontSize: 13, fontFamily: 'Nunito_600SemiBold', color: Colors.child.textSecondary },
  balanceValue: { fontSize: 32, fontFamily: 'Nunito_800ExtraBold', color: '#0B1A2E' },
  body: { paddingHorizontal: 20, paddingTop: 24 },
  sectionTitle: { fontSize: 17, fontFamily: 'Nunito_700Bold', color: Colors.child.text, marginBottom: 12, marginTop: 8 },
  ...
  taskDesc: { fontSize: 12, fontFamily: 'Nunito_400Regular', color: Colors.child.textSecondary, marginTop: 2 },
  taskReward: { alignItems: 'flex-end', gap: 2 },
  taskRewardText: { fontSize: 14, fontFamily: 'Nunito_700Bold', color: '#FF8C00' },
  cardPressed: { opacity: 0.85, transform: [{ scale: 0.98 }] },
  seeAllBtn: { alignItems: 'center', paddingVertical: 10 },
  seeAllText: { fontSize: 14, fontFamily: 'Nunito_600SemiBold', color: '#FF8C00' },
  emptyTasks: {
  ...
  emptyTitle: { fontSize: 15, fontFamily: 'Nunito_600SemiBold', color: Colors.child.text },
  emptyText: { fontSize: 13, fontFamily: 'Nunito_400Regular', color: Colors.child.textSecondary },
  monthStats: {
  ...
  monthStatValue: { fontSize: 18, fontFamily: 'Nunito_800ExtraBold', color: Colors.child.text },
  monthStatLabel: { fontSize: 11, fontFamily: 'Nunito_400Regular', color: Colors.child.textSecondary },
  ...
  missionTitle: { flex: 1, fontSize: 14, fontFamily: 'Nunito_600SemiBold', color: Colors.child.text },
  missionPercent: { fontSize: 14, fontFamily: 'Nunito_700Bold', color: '#22C55E' },
  ...
  missionValues: { fontSize: 12, fontFamily: 'Nunito_400Regular', color: Colors.child.textSecondary },
});
